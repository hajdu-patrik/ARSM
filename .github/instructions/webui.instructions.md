...
- **Phone placeholder examples**: locale keys for login/settings explicitly show EU examples (login: `e.g. +36 30 123 4567`; settings: `e.g. +36 30 123 4567 or +49 151 23456789`).
